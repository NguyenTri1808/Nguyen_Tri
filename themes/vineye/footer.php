...
<footer class="site-footer">
  ...
  // Nếu $SID là bài viết/trang: map sang bản dịch hiện tại
  if (function_exists('pll_get_post') && is_numeric($SID)) {
    $sid_translated = pll_get_post($SID);
    if ($sid_translated) {
      $SID = $sid_translated;
    }
  }
            ...
            <div class="row gy-4">
                <div class="col-12">
                    <div class="info-top d-flex align-items-center gap-3">
                        ...
                        <div class="flex-grow-1">
                            <hr class="info-hr m-0">
                        </div>
                    </div>
                </div>

                <div class="col-12 col-lg-7">
                    <?php if ($heading):  ?><h3 class="info-heading"><?php echo esc_html($heading); ?></h3>
                    <?php endif; ?>
                    ...
                    <a class="hotline-btn" href="tel:<?php echo esc_attr(str_replace(' ','',$hotline)); ?>">
                        <svg width="22" height="22" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24c1.11.37 2.31.57 3.58.57a1 1 0 011 1V21a1 1 0 01-1 1C10.85 22 2 13.15 2 2a1 1 0 011-1h3.5a1 1 0 011 1c0 1.27.2 2.47.57 3.58a1 1 0 01-.24 1.01l-2.2 2.2z" />
                        </svg>
                ...
                <div class="col-12 col-lg-5">
                    <ul class="info-list">
                        <?php if ($addr): ?>
                        <li class="info-item">
                            <span class="info-icon"><svg width="20" height="20" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M12 2a7 7 0 00-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 00-7-7zm0 9.5A2.5 2.5 0 119.5 9 2.5 2.5 0 0112 11.5z" />
                                </svg></span>
                            <div class="info-text"><strong>Địa
                                    chỉ:</strong><span><?php echo nl2br(esc_html($addr)); ?></span></div>
                        </li>
                        <?php endif; ?>
                        <?php if ($hotline): ?>
                        <li class="info-item">
                            ...
                            <div class="info-text">
                                <strong>Hotline:</strong><span><?php echo esc_html($hotline); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        <?php if ($time): ?>
                        <li class="info-item">
                            <span class="info-icon"><svg width="20" height="20" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M12 1a11 11 0 1011 11A11 11 0 0012 1zm1 11H7V10h5V5h2z" />
                                </svg></span>
                            <div class="info-text"><strong>Giờ làm
                                    việc:</strong><span><?php echo nl2br(esc_html($time)); ?></span></div>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
